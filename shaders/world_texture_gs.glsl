...
void main() {
  ...
  normal = vec3(0.0, 0.0, 1.0);
  texture_position = vec2(0.00 + d, 0.75 - d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x2, y2, z2, 1);
  world_position = vec3(x2, y2, z2);
  normal = vec3(0.0, 0.0, 1.0);
  ...
  texture_position = vec2(0.75 - d, 1.00 - d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x1, y2, z2, 1);
  world_position = vec3(x1, y2, z2);
  normal = vec3(-1.0, 0.0, 0.0);
  texture_position = vec2(0.50 + d, 0.75 + d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x1, y2, z1, 1);
  world_position = vec3(x1, y2, z1);
  normal = vec3(-1.0, 0.0, 0.0);
  texture_position = vec2(0.50 + d, 1.00 - d);
  EmitVertex();
  EndPrimitive();
  gl_Position = projection_matrix * vec4(x1, y1, z1, 1);
  world_position = vec3(x1, y1, z1);
  ...
  world_position = vec3(x1, y1, z2);
  normal = vec3(-1.0, 0.0, 0.0);
  texture_position = vec2(0.75 - d, 0.75 + d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x1, y2, z2, 1);
  world_position = vec3(x1, y2, z2);
  normal = vec3(-1.0, 0.0, 0.0);
  ...
  world_position = vec3(x2, y2, z2);
  normal = vec3(0.0, 1.0, 0.0);
  texture_position = vec2(0.50 - d, 0.50 + d);
  EmitVertex();
  ...
  world_position = vec3(x1, y1, z1);
  normal = vec3(0.0, 0.0, -1.0);
  texture_position = vec2(0.75 - d, 0.50 + d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x2, y2, z1, 1);
  world_position = vec3(x2, y2, z1);
  normal = vec3(0.0, 0.0, -1.0);
  ...
  world_position = vec3(x2, y1, z1);
  normal = vec3(1.0, 0.0, 0.0);
  texture_position = vec2(0.75 - d, 0.25 + d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x2, y2, z2, 1);
  world_position = vec3(x2, y2, z2);
  normal = vec3(1.0, 0.0, 0.0);
  ...
  world_position = vec3(x2, y2, z1);
  normal = vec3(1.0, 0.0, 0.0);
  texture_position = vec2(0.50 + d, 0.25 + d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x2, y2, z2, 1);
  world_position = vec3(x2, y2, z2);
  normal = vec3(1.0, 0.0, 0.0);
  ...
  world_position = vec3(x2, y1, z2);
  normal = vec3(0.0, -1.0, 0.0);
  texture_position = vec2(1.00 - d, 0.75 - d);
  EmitVertex();
  gl_Position = projection_matrix * vec4(x1, y1, z2, 1);
  world_position = vec3(x1, y1, z2);
  normal = vec3(0.0, -1.0, 0.0);
  texture_position = vec2(1.00 - d, 0.50 + d);
  EmitVertex();
  EndPrimitive();
  gl_Position = projection_matrix * vec4(x1, y1, z1, 1);
  world_position = vec3(x1, y1, z1);
